...
class Styles {
  ...
  static Color organgeColor = const Color(0xFFF37B67);
  ...
  static TextStyle headLineStyle2 = TextStyle(fontSize: 21, color: textColor, fontWeight: FontWeight.bold);
   static TextStyle headLineStyle3 = TextStyle(fontSize: 17, color: Colors.grey.shade800, fontWeight: FontWeight.w700);
