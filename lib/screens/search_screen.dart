...
class SearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final size = AppLayout.getSize(context); //gets the size of the screen.
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const AppIconText(
              icon: Icons.flight_takeoff_rounded, texto: "Departures"),
          Gap(AppLayout.getHeight(20)),
          const AppIconText(icon: Icons.flight_land_rounded, texto: 'Arrivals'),
          Gap(AppLayout.getHeight(25)),
          Container(
            padding: EdgeInsets.symmetric(
          ...
          Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(AppLayout.getHeight(29)),
                  boxShadow: [
                    BoxShadow(
              ...
              Column(
                children: [
                 ...
                 Stack( // stack para apliar widgets
                    children: [
                      Container(
                      ...
                      Positioned( // para posicionarlo arriba derecha
                      right: -45,
                      top: -40,
                        child: Container(
